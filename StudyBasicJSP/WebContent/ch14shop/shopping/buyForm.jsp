...
%>
		<tr>
			...
			<%=cartList.getBook_title() %></td>
			<td width="150"><%=NumberFormat.getInstance().format(cartList.getBuy_price())%></td>
...
<%} %>
		<tr>
			<td colspan="5" align="right"><font size="3" color="blue"><b>총 구매금액: &nbsp;
